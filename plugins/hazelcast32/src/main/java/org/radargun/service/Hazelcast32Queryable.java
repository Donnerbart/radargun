 ...
 */
public class Hazelcast32Queryable implements Queryable {
   private static final Log log = LogFactory.getLog(Hazelcast32Queryable.class);
   protected final HazelcastService service;

   public Hazelcast32Queryable(HazelcastService service) {
